...
public class AdminController {
    ...
    /*
      ...
      */
    @GetMapping("/articles")
    public ResponseEntity<AdminArticleListResponseDto> getAllArticles(
            @RequestParam(required = false) String title,
            @RequestParam(required = false) String content,
            @RequestParam(required = false) String hashtag,
            @PageableDefault Pageable pageable
    ) {
        ResponseEntity<AdminArticleListResponseDto> response = adminService.getAllArticles(title, content,hashtag, pageable);
        return response;
    }
