...
public class AdminArticleDetailDto {
    ...
    public AdminArticleDetailDto(Long id, String title, String writer, String content, HashTagTypeEnum tagType, int favoriteCount, int viewCount, List<String> hashtag) {
        this.id = id;
        this.title = title;
        this.writer = writer;
