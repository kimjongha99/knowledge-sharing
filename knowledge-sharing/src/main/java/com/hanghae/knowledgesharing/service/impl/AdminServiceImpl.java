...
import com.hanghae.knowledgesharing.dto.response.admin.*;
...
public class AdminServiceImpl implements AdminService {
    ...
    @Override
    public ResponseEntity<ArticleListResponseDto> getAllArticles(String title, String content, String hashtag, Pageable pageable) {
        Page<Article> articles = articleRepository.findByTitleAndContentAndHashtagName(title, content, hashtag, pageable);

        Page<ArticleDetailDto> articleDetailPage = articles.map(article -> {
        ...
        return ArticleListResponseDto.success(articleDetailPage);
    }
